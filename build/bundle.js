...
(0, _utils.$)(document).ready(function () {
	var genreResult = {},
	    ...
	    genreStart = 0,
	    genreEnd = 6,
	    genreMoviesToShow = function genreMoviesToShow(genreResult, genreStart, genreEnd) {
		return genreResult.slice(genreStart, genreEnd);
	};
	...
	function getGenreAction() {
		var output = '';
		_axios2.default.get('https://api.themoviedb.org/3/discover/movie?api_key=436fedae44d7b81338702a9341ae7a74&language=en-US&include_adult=false&include_video=false&page=1&with_genres=28&sort_by=popularity.desc').then(function (response) {
			genreResult = response.data.results;
			console.log(response);
			_utils.$.each(genreMoviesToShow(genreResult, genreStart, genreEnd), function (index, movie) {
	...
	function getGenreDrama() {
		var output = '';
		_axios2.default.get('https://api.themoviedb.org/3/discover/movie?api_key=436fedae44d7b81338702a9341ae7a74&language=en-US&include_adult=false&include_video=false&page=1&with_genres=18&sort_by=popularity.desc').then(function (response) {
			genreResult = response.data.results;
			console.log(response);
			_utils.$.each(genreMoviesToShow(genreResult, genreStart, genreEnd), function (index, movie) {
				output += '\n\t\t\t<div class="col-xs-12 col-sm-6 col-md-2 no-padding movie" data-id=' + movie.id + '>\n\t\t\t\t<div class="text-center">\n\t\t\t\t\t<object data="https://image.tmdb.org/t/p/w154' + movie.poster_path + '" type="image/jpg">\n\t\t\t\t\t\t<img src="img/default.png" />\n\t\t\t\t\t</object>\n\t\t\t\t\t<p class="film-block-new-title">' + movie.title + '</p>\n          <div class="overlay">\n            <button id="infoBtn" class="btn show-more-dark">See more info</a>\n          </div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t\t\t';
			});
			(0, _utils.$)('#drama').html(output);
		}).catch(function (err) {
			console.log(err);
		});
	}
	function getGenreСomedy() {
		var output = '';
		_axios2.default.get('https://api.themoviedb.org/3/discover/movie?api_key=436fedae44d7b81338702a9341ae7a74&language=en-US&include_adult=false&include_video=false&page=1&with_genres=35&sort_by=popularity.desc').then(function (response) {
			genreResult = response.data.results;
			console.log(response);
			_utils.$.each(genreMoviesToShow(genreResult, genreStart, genreEnd), function (index, movie) {
				output += '\n\t\t\t<div class="col-xs-12 col-sm-6 col-md-2 no-padding movie" data-id=' + movie.id + '>\n\t\t\t\t<div class="text-center">\n\t\t\t\t\t<object data="https://image.tmdb.org/t/p/w154' + movie.poster_path + '" type="image/jpg">\n\t\t\t\t\t\t<img src="img/default.png" />\n\t\t\t\t\t</object>\n\t\t\t\t\t<p class="film-block-new-title">' + movie.title + '</p>\n          <div class="overlay">\n            <button id="infoBtn" class="btn show-more-dark">See more info</a>\n          </div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t\t\t';
...
(0, _utils.$)(document).ready(function () {
	...
	(0, _utils.$)('#movies, #popular, #new, #in_theatres, #action, #drama, #comedy').on('click', '.movie', function () {
		(0, _utils.$)('#myModal').modal('show');
		movieID = (0, _utils.$)(this).data('id');
	...
	function getMovieInfo(movieID) {
		_axios2.default.get('https://api.themoviedb.org/3/movie/' + movieID + '?api_key=436fedae44d7b81338702a9341ae7a74').then(function (response) {
			movie = response.data;
			console.log(movie);
			...
			_utils.$.map(genres, function (genre) {
				...
				(0, _utils.$)('#genres').append(genre);
			});
		});
	};

	function getCastsInfo(movieID) {
		_axios2.default.get('https://api.themoviedb.org/3/movie/' + movieID + '/credits?api_key=436fedae44d7b81338702a9341ae7a74').then(function (response) {
			var castsResponce = response.data;
			var casts = castsResponce.cast;
			casts = casts.slice(0, 4);
			console.log(castsResponce);
			_utils.$.map(casts, function (movie) {
				...
				(0, _utils.$)('#casts').append(actors);
			});
		});
	}

	function getMovieImgs(movieID) {
		_axios2.default.get('https://api.themoviedb.org/3/movie/' + movieID + '/images?api_key=436fedae44d7b81338702a9341ae7a74').then(function (response) {
			var imgResponce = response.data.backdrops;
			imgResponce = imgResponce.slice(0, 10);
			console.log(imgResponce);
			_utils.$.map(imgResponce, function (img) {
				var images = '\n\t\t\t<div>\n\t\t\t<img src="https://image.tmdb.org/t/p/w300' + img.file_path + '" alt="" /></div>';
				(0, _utils.$)('#images').append(images);
			});
			initSlider();
		});
	}
	...
	function getMovieTrailer(movieID) {
		_axios2.default.get('https://api.themoviedb.org/3/movie/' + movieID + '/videos?api_key=436fedae44d7b81338702a9341ae7a74').then(function (response) {
			var movieTrailer = response.data.results;
			console.log(movieTrailer);
			movieTrailer = movieTrailer.slice(0, 1);
			_utils.$.map(movieTrailer, function (video) {
				...
				(0, _utils.$)('#trailer').append(trailer);
			});
		});
	};

	function initSlider() {
		(0, _utils.$)('.img-slider').slick({
			lazyLoad: 'ondemand',
			infinite: true,
			variableWidth: true,
			autoplay: true,
	...
	(0, _utils.$)('#myModal').on('hidden.bs.modal', function () {
		(0, _utils.$)('#myModal .modal-content').find('#modalInner').attr('src', '');
	});
});
...
(0, _utils.$)(document).ready(function () {
  (0, _utils.$)('#searchForm').on('submit', function (e) {
    var searchText = (0, _utils.$)('#searchText').val();
...
function getMovies(searchText) {
  _axios2.default.get('https://api.themoviedb.org/3/search/movie?api_key=436fedae44d7b81338702a9341ae7a74&language=ua&query=' + searchText).then(function (response) {
    console.log(response);
...
(0, _utils.$)(document).ready(function () {
  ...
  function getUpcomingMovies() {
    _axios2.default.get('https://api.themoviedb.org/3/movie/upcoming?api_key=436fedae44d7b81338702a9341ae7a74&language=ua-UA&page=1&region=UA').then(function (response) {
      console.log(response);
      var upcomingMovies = response.data.results.slice(0, 4);
      var output = '';
      _utils.$.each(upcomingMovies, function (index, movie) {
        output += '\n      <div class="col-xs-12 col-sm-6 col-md-6 no-padding movie" data-id=' + movie.id + '>\n        <div class="film-block-new text-center">\n          <img class="film-block-new-img" src="https://image.tmdb.org/t/p/w154' + movie.poster_path + '">\n          <p class="film-block-new-title">' + movie.title + '</p>\n          <div class="overlay">\n            <button id="infoBtn" class="btn show-more-dark">See more info</a>\n          </div>\n        </div>\n      </div>\n          ';
      });
      (0, _utils.$)('#in_theatres').html(output);
    }).catch(function (err) {
      console.log(err);
    });
  };
...
(0, _utils.$)(document).ready(function () {
  ...
  function getNewMovies() {
    _axios2.default.get('https://api.themoviedb.org/3/discover/movie?api_key=436fedae44d7b81338702a9341ae7a74&primary_release_date.gte=2017-06-01&sort_by=popularity.desc').then(function (response) {
      console.log(response);
      var newMovies = response.data.results;
      var newOutput = '';
      _utils.$.each(newMovies.slice(0, 6), function (index, movie) {
        newOutput += '\n      <div class="col-xs-6 col-sm-4 col-md-4 no-padding movie" data-id=' + movie.id + '>\n        <div class="film-block-new text-center">\n          <img class="film-block-new-img" src="https://image.tmdb.org/t/p/w154' + movie.poster_path + '">\n          <p class="film-block-new-title">' + movie.title + '</p>\n          <div class="overlay">\n            <button id="infoBtn" class="btn show-more-dark">See more info</a>\n          </div>\n        </div>\n      </div>\n          ';
      });
      (0, _utils.$)('#newMovies').html(newOutput);
    }).catch(function (err) {
      console.log(err);
    });
  };
...
(0, _utils.$)(document).ready(function () {
	...
	var popMovies = [],
		...
		return 'https://api.themoviedb.org/3/discover/movie?api_key=436fedae44d7b81338702a9341ae7a74&sort_by=popularity.desc&vote_average.gte=7&page=' + pageNumber;
	},
	    start = 0,
	    end = 4,
	    showMovies = function showMovies(popMovies, start, end) {
	...
	function getPopularMovies(start, end) {
		var popOutput = '';
		_axios2.default.get(getUrl()).then(function (response) {
...
!function (a) {
  "use strict";
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(37)], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
